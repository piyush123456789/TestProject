...
public class Player : MonoBehaviour {
	...
	[SerializeField] private TextMesh vegetablesUI, choppedVegetablesUI,popUpMessageUI;
	...
	private void CheckInteractionDelay(){
		if(!this.canInteract){
			...
			if(interactionFrameCounter >= interactionDelay) {
                ...
                Debug.Log("CheckInteractionDelay");
	...
	public bool IsTryingToInteract{
		...
		set{
            Debug.Log("IsTryingToInteract"+value);
